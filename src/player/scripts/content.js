...
function startGLS() {
  ...
  const welcomeTooltip = $(
    '<div id="step1" style="background-color: rgb(133, 202, 246); border-radius: 5%; border: 2px solid black; display: inline-block; padding: 10px; margin-top: 26px; margin-left: -166px;"><h3 style="color: #163658;">Welcome to Google.com</h3><span class="cross" style="color: #080808;float: right;top: -56px;position: relative;right: -12px;border-radius: 50%;cursor: pointer;width: 17px;font-size: 12px;"> ✖ </span><button class="back" style="background-color: #4CAF50;border: none;color: white;padding: 5px 5px;text-align: center;text-decoration: none;display: inline-block;font-size: 12px;margin: 0px 5px 5px 5px;cursor: pointer;border-radius: 6px;position: relative;left: -9px;bottom: -7px;">❮ Back </button><button class="next" style="background-color: #4CAF50;border: none;color: white;padding: 5px 5px;text-align: center;text-decoration: none;display: inline-block;font-size: 12px;margin: 0px;cursor: pointer;border-radius: 6px;position: relative;right: -96px;bottom: -7px;z-index: 1;">Next ❯</button><span style="float:right;height: 16px;width: 16px;display: inline-block;background-color: #85CAF6;position: relative;transform: rotate(134deg);bottom: -29px;border-width: inherit;border-style: solid;border-color: black black #85CAF6 #85CAF6;"></span></div>',
  );
  ...
  const voiceSearchTooltip = $(
    '<div id="step4" style="background-color: rgb(133, 202, 246);border-radius: 5%;border: 2px solid black;display: inline-block;padding: 10px;margin: 16px;position: absolute;right: -166px;top: -134px;"><h3 style="color: #163658;">Click to search by voice!</h3><span class="cross" style="color: #080808;float: right;top: -58px;position: relative;right: -9px;border-radius: 50%;cursor: pointer;width: 17px;"> ✖ </span><button class="back" style="background-color: #4CAF50;border: none;color: white;padding: 5px 5px;text-align: center;text-decoration: none;display: inline-block;font-size: 12px;margin: 0px 5px 5px 5px;cursor: pointer;border-radius: 6px;position: relative;left: -9px;bottom: -6px;z-index: 1;">❮ Back </button><button class="next" style="background-color: #4CAF50;border: none;color: white;padding: 5px 5px;text-align: center;text-decoration: none;display: inline-block;font-size: 12px;margin: 0px;cursor: pointer;border-radius: 6px;position: relative;right: -96px;bottom: -6px;">Next ❯</button><span style="right: 84px;height: 16px;width: 16px;display: inline-block;background-color: #85CAF6;transform: rotate(134deg);bottom: -33px;border-width: inherit;border-style: solid;border-color: black black #85CAF6 #85CAF6;position: relative;"></span></div>',
  );
